...
const aLambdasian = new Lambdasian ('Petar', 23, 'NY City')
console.log(aLambdasian.speak());
/*
  TASK 4
...
demo(subject){
return `Today we about ${subject} where subject is the param passed in.`
}
grade(student, subject){
  return `${student.name} receives a perfect score on ${subject}`
}
}
const anInstructor = new Instructor('Luis', 30, 'Philadelphia', 'SQL', 'C#',)
console.log(anInstructor.speak());
/*
  TASK 5
...
const student1 = new Student ('Matt', 22, 'Chicago', 'Plumber', 'WebEU 3', 'JS, Node, Redux')
...
const PM = new ProjectManager('Dan', 50, 'Web25')
